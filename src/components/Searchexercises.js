...
const Searchexercises = ({setExercises,setBodyPart, bodyPart , exercises}) => {
  ...
  const handleSearch=async()=>{
    if(search){
      ...
      const searchedExericses= exercisesData.filter((exercise)=>exercise.name.toLowerCase().includes(search) || 
    ...
    setSearch('')
    setExercises(searchedExericses)
  }
}
  return (
